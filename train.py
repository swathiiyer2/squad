...
def main(args):
    ...
    #load these in addition for the conv networks
...
def evaluate(model, data_loader, device, eval_file, max_len, use_squad_v2, uses_char_embeddings):
